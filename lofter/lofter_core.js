...
(function() {
    ...
    var bHo = {blk: /^\{(cdata|minify|eval)/i,
                 tag: "forelse|for|list|if|elseif|else|var|macro|break",
                   def: {"if": {pfix: "if(",sfix: "){",pmin: 1},
                         "else": {pfix: "}else{"},
                          elseif: {pfix: "}else if(",
                          sfix: "){",pdft: "true"},
                          "/if": {pfix: "}"},
                 ...
                 ext: {trim: U.bA,rand: U.cA,escape: U.ew,format: U.ws,string: U.IY,substr: U.bgB,"default": function(bg, bwI) {
        return bg || bwI
    }}};
